...
class LocalizationService extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'Please tap on location icon to get your address':
              'Please tap on location icon to get your'
                  ' address',
        ...
        'ar_EG': {
          ...
          'No coordinates found for this address.':
              'لم يتم العثور على إحداثيات لهذا العنوان.',
          ...
          'Sorry this service is not available':
              'عفوا هذه الخدمة ليست متوفرة حاليا',
          ...
          'Wallet is not available at Pickup role':
              'المحفظة غير متاحة في وظيفة '
                  'الاستلام',
          ...
          'Please tap on location icon to get your address':
              'الرجاء الضغط على أيقونة الموقع للحصول على عنوانك',
